...
pdf("graphs/math-reg-scatterplots.pdf")
par(mfrow=c(2,2))
sink("Math-Regression-Output.txt")

# holdout
R1=fit(G3~.,math[H$tr,c(inputs,g3)],model="rpart")
...
# k-fold cross-validation
R2=crossvaldata(G3~.,math[,c(inputs,g3)],fit,predict,ngroup=10,seed=123,model="ctree",task="reg")
P2=R2$cv.fit # k-fold predictions on full dataset
e2=mmetric(math$G3,P2,metric=c("RMSE","MAE"))
...
# holdout
R1=fit(G3~.,math[H$tr,c(inputs,g3)],model="mlpe")
P1=predict(R1,math[H$ts,c(inputs,g3)])
target1=math[H$ts,]$G3
e1=mmetric(target1,P1,metric=c("RMSE","MAE"))
...
# k-fold cross-validation
R2=crossvaldata(G3~.,math[,c(inputs,g3)],fit,predict,ngroup=10,seed=123,model="mlpe",task="reg")
P2=R2$cv.fit # k-fold predictions on full dataset
e2=mmetric(math$G3,P2,metric=c("RMSE","MAE"))
...
# holdout
R1=fit(G3~.,math[H$tr,c(inputs,g3)],model="svm")
P1=predict(R1,math[H$ts,c(inputs,g3)])
target1=math[H$ts,]$G3
e1=mmetric(target1,P1,metric=c("RMSE","MAE"))
...
# k-fold cross-validation
R2=crossvaldata(G3~.,math[,c(inputs,g3)],fit,predict,ngroup=10,seed=123,model="svm",task="reg")
P2=R2$cv.fit # k-fold predictions on full dataset
e2=mmetric(math$G3,P2,metric=c("RMSE","MAE"))
...
# holdout
R1=fit(G3~.,math[H$tr,c(inputs,g3)],model="naive")
P1=predict(R1,math[H$ts,c(inputs,g3)])
target1=math[H$ts,]$G3
e1=mmetric(target1,P1,metric=c("RMSE","MAE"))
...
# k-fold cross-validation
R2=crossvaldata(G3~.,math[,c(inputs,g3)],fit,predict,ngroup=10,seed=123,model="naive",task="reg")
P2=R2$cv.fit # k-fold predictions on full dataset
e2=mmetric(math$G3,P2,metric=c("RMSE","MAE"))
...
# holdout
R1=fit(G3~.,math[H$tr,c(inputs,g3)],model="knn")
P1=predict(R1,math[H$ts,c(inputs,g3)])
target1=math[H$ts,]$G3
e1=mmetric(target1,P1,metric=c("RMSE","MAE"))
...
# k-fold cross-validation
R2=crossvaldata(G3~.,math[,c(inputs,g3)],fit,predict,ngroup=10,seed=123,model="knn",task="reg")
P2=R2$cv.fit # k-fold predictions on full dataset
e2=mmetric(math$G3,P2,metric=c("RMSE","MAE"))
...
# holdout
R1=fit(G3~.,math[H$tr,c(inputs,g3)],model="lr")
P1=predict(R1,math[H$ts,c(inputs,g3)])
target1=math[H$ts,]$G3
e1=mmetric(target1,P1,metric=c("RMSE","MAE"))
...
# k-fold cross-validation
R2=crossvaldata(G3~.,math[,c(inputs,g3)],fit,predict,ngroup=10,seed=123,model="lr",task="reg")
P2=R2$cv.fit # k-fold predictions on full dataset
e2=mmetric(math$G3,P2,metric=c("RMSE","MAE"))
...
# holdout
R1=fit(G3~.,math[H$tr,c(inputs,g3)],model="mr")
P1=predict(R1,math[H$ts,c(inputs,g3)])
target1=math[H$ts,]$G3
e1=mmetric(target1,P1,metric=c("RMSE","MAE"))
...
# k-fold cross-validation
R2=crossvaldata(G3~.,math[,c(inputs,g3)],fit,predict,ngroup=10,seed=123,model="mr",task="reg")
P2=R2$cv.fit # k-fold predictions on full dataset
e2=mmetric(math$G3,P2,metric=c("RMSE","MAE"))
